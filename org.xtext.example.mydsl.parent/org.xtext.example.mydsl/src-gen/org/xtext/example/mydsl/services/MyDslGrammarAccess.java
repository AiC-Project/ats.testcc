...
public class MyDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class IncludesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.Includes");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PlaneElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.Plane");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//Plane:
		//	'Avion' name=ID ':' ('Passagers' ':' passengers=INT ';'
		//	& 'Motorisation' ':' motorisation=Engines ';')
		//	'End.';
		@Override public ParserRule getRule() { return rule; }
		
		//'Avion' name=ID ':' ('Passagers' ':' passengers=INT ';' & 'Motorisation' ':' motorisation=Engines ';') 'End.'
		public Group getGroup() { return cGroup; }
		...
		//('Passagers' ':' passengers=INT ';' & 'Motorisation' ':' motorisation=Engines ';')
	...
	public class AirportElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.Airport");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//Airport:
		//	'Aeroport' title=STRING ':' ('OACI' ':' name=CodeOACI ';'
		//	& 'Pays' ':' country=STRING ';'
		//	& 'Pistes' ':' runways=INT ';')
		//	'End.';
		@Override public ParserRule getRule() { return rule; }
		
		//'Aeroport' title=STRING ':' ('OACI' ':' name=CodeOACI ';' & 'Pays' ':' country=STRING ';' & 'Pistes' ':' runways=INT
		//';') 'End.'
		public Group getGroup() { return cGroup; }
		...
		//('OACI' ':' name=CodeOACI ';' & 'Pays' ':' country=STRING ';' & 'Pistes' ':' runways=INT ';')
		public UnorderedGroup getUnorderedGroup_3() { return cUnorderedGroup_3; }
	...
	public class AirlineElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.Airline");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//Airline:
		//	'Ligne' name=STRING ':' ('Avion' ':' plane=[Plane] ';'
		...
		//'Ligne' name=STRING ':' ('Avion' ':' plane=[Plane] ';' & 'Compagnie' ':' company=STRING ';' & 'Depart' ':'
		//departure=[CodeOACI|OACI] ';' & 'Arrivee' ':' arrival=[CodeOACI|OACI] ';' & 'Duree' ':' duration=DURATION ';' &
		//regular?='REGULIERE;'?) 'End.'
		public Group getGroup() { return cGroup; }
		...
		//('Avion' ':' plane=[Plane] ';' & 'Compagnie' ':' company=STRING ';' & 'Depart' ':' departure=[CodeOACI|OACI] ';' &
		//'Arrivee' ':' arrival=[CodeOACI|OACI] ';' & 'Duree' ':' duration=DURATION ';' & regular?='REGULIERE;'?)
		public UnorderedGroup getUnorderedGroup_3() { return cUnorderedGroup_3; }
	...
	public class CodeOACIElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.CodeOACI");
	...
	public class EnginesElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.Engines");
	...
	public MyDslGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tDURATION = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.DURATION");
		this.pCodeOACI = new CodeOACIElements();
		this.tOACI = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.OACI");
		this.tINCLUDE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.INCLUDE");
	}
